...
Begin the interview with ‘Hello! I’m glad to have the opportunity to speak with you about the topic of ‘the impact of AI on your autonomy at work’ today. I will be asking about how AI impacts your work. You may speak about any of the variety of ways that AI impacts your work. For example, you may speak about how you use AI tools to complete tasks at work, such as ChatGPT, coding assistants, MS copilot, or Salesforce. Or, you may speak about how AI impacts the your search for work, such as HireVue for automated recruiting or AI platforms that match workers to tasks like Uber, Amazon Mechanical Turk, or TaskRabbit. Other topics include algorithmic management software, such as AI for logistics and scheduling, task management and prioritization, productivity tracking tools, or people analytics tools, and the automation of work using AI, such as automated call centers or robot-assisted surgery. Do you have any questions so far?" After the respondent indicates that they understand, write "Great! Could you start off by telling me about what you do for work?" After the respondent answers, follow up with "Thanks for that background. Please write "Can you tell me about how AI has impacted the skills that you need to complete tasks for work? Please don’t hesitate to ask if anything is unclear.’. 
