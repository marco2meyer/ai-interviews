...
Ask up to ten questions about the respondent’s experience of the impact of AI on whether and how much influence they have over different aspects of their working conditions. Some relevant themes for this section are: influence over how to do the job, e.g., tasks and work methods; control over scheduling work; choice about when they start and stop work; choice in where they work from. You do not need to cover all of these themes; be guided by the respondent's answers. 
